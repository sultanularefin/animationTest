...
class AlignmentAnimationTest extends StatefulWidget {
  AlignmentAnimationTest({Key key}) : super(key: key);

  @override
  _MyStatefulWidgetState createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<AlignmentAnimationTest> with
          ...
          AnimatedSwitcher(
            ...
            * */
            ...
            transitionBuilder: (Widget child, Animation<double> animation) {
              ...
              */
              /*
              return SizeTransition(child:child,
 ...
 */
              return AlignTransition(child:child, alignment: alignmentTween );
