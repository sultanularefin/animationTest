...
class BoxDecorationTest extends StatefulWidget {
  BoxDecorationTest({Key key}) : super(key: key);

  @override
  _MyStatefulWidgetState createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<BoxDecorationTest> with
